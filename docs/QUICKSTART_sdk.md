...
This loads `../examples/example_receipt_v2.json` and `../examples/example_ledger.json`, runs the independent verification logic, and prints the result.
...
============================================================
 Receipt file  : ../examples/example_receipt_v2.json
 Ledger file   : ../examples/example_ledger.json
============================================================
